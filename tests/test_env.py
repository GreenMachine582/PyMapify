...
class TestEnv(unittest.TestCase):
    ...
    @patch("src.pymapify.utils.env.os_path.exists")
    @patch("src.pymapify.utils.env.Config")
    @patch("src.pymapify.utils.env.LoggerHandler")
    ...
    def test_call_updates_attributes(self, mock_config, mock_exist_path):
        ...
        with patch("src.pymapify.utils.env._logger.warning") as mock_warning:
    ...
    @patch("src.pymapify.utils.env.Config")
    @patch("src.pymapify.utils.env.os_path.exists", return_value=True)
    ...
    @patch("src.pymapify.utils.env.os_path.exists", return_value=False)
...
class TestEnvDatabase(unittest.TestCase):
    ...
    @patch('src.pymapify.utils.env._logger')
