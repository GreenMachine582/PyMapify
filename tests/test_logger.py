...
from src.pymapify.utils.logger import LoggerHandler, _validateLogLevel, _buildLogDirectory
...
class TestLoggerHandler(unittest.TestCase):
    ...
    @patch("src.pymapify.utils.logger.makedirs")
    ...
    @patch("src.pymapify.utils.logger.listdir", return_value=["test.log"])
    ...
    @patch("src.pymapify.utils.logger.makedirs")
    @patch("src.pymapify.utils.logger.path.getctime")
    @patch("src.pymapify.utils.logger.path.isfile", return_value=True)
    @patch("src.pymapify.utils.logger.listdir", return_value=["old_logfile.log"])
    @patch("src.pymapify.utils.logger.RotatingFileHandler")
    @patch("src.pymapify.utils.logger._logger")
    @patch("src.pymapify.utils.logger.os_remove")
    ...
    @patch("src.pymapify.utils.logger.RotatingFileHandler")
    @patch("src.pymapify.utils.logger._logger")
    @patch("src.pymapify.utils.logger.os_remove", side_effect=PermissionError)
    ...
    @patch("src.pymapify.utils.logger.makedirs")
    @patch("src.pymapify.utils.logger.listdir", return_value=["test.log"])
    @patch("src.pymapify.utils.logger.path.getctime", return_value=time.time())
    @patch("src.pymapify.utils.logger.path.isfile", return_value=True)
    @patch("src.pymapify.utils.logger.RotatingFileHandler")
    @patch("src.pymapify.utils.logger.os_remove")
    ...
    @patch("src.pymapify.utils.logger.makedirs")
    @patch("src.pymapify.utils.logger.listdir", return_value=["test.log"])
    @patch("src.pymapify.utils.logger.logging.StreamHandler")
    @patch("src.pymapify.utils.logger.logging.getLogger")
    ...
    @patch("src.pymapify.utils.logger.makedirs")
    @patch("src.pymapify.utils.logger.listdir", return_value=[])
